    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        help_text="Descripción o biografía del usuario",
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="Si el email del usuario ha sido verificado",
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="Si la autenticación de dos factores está habilitada",
                ...
                (
                    ...
                    models.JSONField(
                        blank=True,
                        default=list,
                        help_text="Códigos de respaldo para 2FA",
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Clave secreta para TOTP",
                        max_length=32,
                ...
                (
                    ...
                    models.GenericIPAddressField(
                        blank=True,
                        help_text="Última dirección IP desde la que se conectó",
                        null=True,
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        help_text="Último navegador/dispositivo usado",
                        verbose_name="Último User Agent",
                    ),
                ),
                (
                    "last_location",
                    models.CharField(
                        blank=True,
                        help_text="Última ubicación geográfica detectada",
                        max_length=100,
                        verbose_name="Última ubicación",
                    ),
                ),
                (
                ...
                (
                    ...
                    models.DateTimeField(
                        blank=True,
                        help_text="Fecha y hora hasta cuando la cuenta está bloqueada",
                        null=True,
                ...
                (
                    ...
                    models.BooleanField(
                        default=True,
                        help_text="Designa si el usuario debe ser tratado como activo. Desmarcar en lugar de eliminar cuentas.",
                        verbose_name="Activo",
                    ),
                ),
                (
                ...
                (
                    ...
                    models.DateTimeField(
                        auto_now_add=True,
                        help_text="Fecha y hora cuando el usuario se registró",
                ...
                (
                    ...
                    models.CharField(
                        ...
                        default="MEMBER",
                        help_text="Rol del usuario dentro de la organización",
                        max_length=20,
                        verbose_name="Rol en organizacion",
                    ),
                ),
                (
                    "groups",
                ...
                (
                    ...
                    models.ForeignKey(
                        blank=True,
                        help_text="Organización a la que pertenece este usuario",
                        null=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "reason",
                    models.CharField(blank=True, max_length=200, verbose_name="Razón"),
                ),
                (
                    "timestamp",
                    models.DateTimeField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "session_key",
                    models.CharField(
                        max_length=40, unique=True, verbose_name="Clave de sesión"
                    ),
                ),
                (
                    "ip_address",
        ...
        migrations.AddIndex(
            model_name="customuser",
            index=models.Index(
                fields=["is_active"], name="login_custo_is_acti_6a4d43_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="customuser",
            index=models.Index(
                fields=["date_joined"], name="login_custo_date_jo_1d5b86_idx"
            ),
        ),
    ]
