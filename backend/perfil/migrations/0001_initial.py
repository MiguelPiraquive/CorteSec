        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        help_text="Describa cualquier alergia conocida",
                        null=True,
                ...
                (
                    "profesion",
                    models.CharField(
                        blank=True, max_length=100, null=True, verbose_name="Profesión"
                    ),
                ),
                (
                    "habilidades",
                    models.TextField(
                        blank=True,
                        help_text="Describa sus habilidades principales",
                        null=True,
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        help_text="Resumen de experiencia laboral relevante",
                        null=True,
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        help_text="Certificaciones profesionales obtenidas",
                        null=True,
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Número de cuenta bancaria para pagos",
                        max_length=20,
                        null=True,
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="Indica si el perfil tiene la información mínima requerida",
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="Si algunos datos pueden ser visibles a otros usuarios",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        default=True,
                        help_text="Recibir notificaciones sobre préstamos",
                        verbose_name="Notificaciones de préstamos",
                    ),
                ),
                (
                    "notif_nomina",
                    models.BooleanField(
                        default=True,
                        help_text="Recibir notificaciones sobre nómina",
                ...
                (
                    ...
                    models.BooleanField(
                        default=True,
                        help_text="Recibir notificaciones sobre documentos",
                        verbose_name="Notificaciones de documentos",
                    ),
                ),
                (
                    "notif_sistema",
                    models.BooleanField(
                        default=True,
                        help_text="Recibir notificaciones importantes del sistema",
                ...
                (
                    ...
                    models.BooleanField(
                        default=True,
                        help_text="Mostrar notificaciones en la plataforma",
                        verbose_name="En la plataforma",
                    ),
                ),
                (
                    "horario_inicio",
                    models.TimeField(
                        default="08:00",
                        help_text="Hora desde la cual recibir notificaciones",
                        verbose_name="Hora inicio notificaciones",
                    ),
                ),
                (
                    "horario_fin",
                    models.TimeField(
                        default="18:00",
                        help_text="Hora hasta la cual recibir notificaciones",
                        verbose_name="Hora fin notificaciones",
                    ),
                ),
                (
                    "perfil",
