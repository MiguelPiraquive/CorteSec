...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Redirigir a una página de confirmación de registro
    ...
    <div className="login-bg-hero">
      ...
      <div className="login-panel">
        ...
        <div className="login-panel-left">
          ...
          <div className="brand-slogan">Crea tu cuenta y gestiona tus cortes fácilmente.</div>
          <div className="brand-desc">
            Regístrate para acceder a todas las funcionalidades de la plataforma y llevar el control de tus proyectos de manera profesional y segura.
          </div>
        </div>
          ...
          <form onSubmit={handleSubmit} className="login-form">
            ...
            <div className="login-form-group">
              ...
              {validationErrors.password_confirm && (
                <div className="login-error">{validationErrors.password_confirm}</div>
              )}
            </div>

            <div className="login-form-actions">
              <button type="submit" className="login-btn" disabled={isSubmitting || loading}>
                {isSubmitting || loading ? 'Creando cuenta...' : 'Registrarse'}
              </button>
              <Link to="/auth/login" className="signup-btn">¿Ya tienes cuenta?</Link>
            </div>

            <div className="login-form-links">
              <Link to="/auth/forgot-password" className="login-link">¿Olvidaste tu contraseña?</Link>
            </div>
          </form>
