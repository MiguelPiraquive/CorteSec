    ...
    <div className="login-bg-hero">
      ...
      <div className="login-panel">
        ...
        <div className="login-panel-left">
          ...
          <h2 className="brand-welcome">¡Contraseña cambiada!</h2>
          <div className="brand-slogan">Acceso restablecido</div>
        ...
        <div className="login-panel-right" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          <div className="login-form" style={{ width: '100%', textAlign: 'center' }}>
            ...
            <Link to="/auth/login" className="login-btn" style={{ width: '100%', maxWidth: '260px', textDecoration: 'none', display: 'inline-block' }}>
              Iniciar Sesión
            </Link>
          </div>
